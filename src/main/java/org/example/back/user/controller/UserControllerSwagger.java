...
public interface UserControllerSwagger {
    ...
    @Operation(
            summary = "회원가입 요청",
            description = "회원가입 요청을 합니다."
    )
    @ApiResponse(
            responseCode = "200",
            description = "회원가입 요청에 성공하였습니다."
    )
    public ResponseEntity<User> signUp(SignUpRequestDto dto);
